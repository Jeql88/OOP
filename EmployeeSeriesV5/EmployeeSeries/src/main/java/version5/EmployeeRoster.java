...
public class EmployeeRoster {
    ...
    public void displayAllEmployee() {
        ...
        empList.forEach(emp -> {
            ...
            if (emp instanceof BasedPlusComissionEmployee) {
                System.out.printf("%,10.2f|", ((BasedPlusComissionEmployee) emp).computeSalary());
            } else if (emp instanceof ComissionEmployee) {
                System.out.printf("%,10.2f|", ((ComissionEmployee) emp).computeSalary());
